...
class MainWindow(QMainWindow):
    ...
    def setwindow(self):
        self.setWindowTitle('NeuralCare-Image')
        ...
        self.resize(int(self.windowWidth // 1.5), int(self.windowHeight // 1.5))
        self.move(
            int((self.windowWidth - self.width()) // 2),
            int((self.windowHeight - self.height()) // 2)
        )

        self.setMinimumSize(int(self.windowWidth // 1.5), int(self.windowHeight // 1.5))
    ...
    def setButton(self):
        ...
        self.buttonWidth, self.buttonHeight = int(self.width()//2), int(self.height()//2)
